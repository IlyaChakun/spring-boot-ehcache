...
//        };
//
//        Predicate<Serializable> test = event -> {
//            TestApmEvent testApmEvent = (TestApmEvent) event;
//            return testApmEvent.getKey().equals(eventNotificationRegistrationAuthorized)
//                    || testApmEvent.getKey().equals(eventNotificationAuthorizationSuccessful);
//        };
//
